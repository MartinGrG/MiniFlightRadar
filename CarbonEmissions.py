...
def global_carbon_emissions(gcd, model, uid, motors_nb=1):
    """
    ...
    return ((factors["a"]*gcd**2+factors["b"]*gcd+factors["c"]+engine_info["Fuel LTO Cycle (kg)  "][0]*motors_nb)
            * (factors["P"]+factors["FE"]*factors["M"]))


def passenger_carbon_emissions(gcd, model, uid, motors_nb=1, seat_class="economy"):
    """
    ...
    return (global_carbon_emissions(gcd, model, uid, motors_nb)*(1-factors["CF"]) *
